...
export const LEARNING_RESOURCES: Resource[] = [
  ...
  // === MORE RESOURCES (35-96) — Free & Open Source 2026 ===
  { id: 35, cat: 'JavaScript', title: 'Eloquent JavaScript (free book)', desc: 'Classic interactive programming text covering modern concepts.', link: 'https://eloquentjavascript.net', level: 'Beginner→Intermediate' },
  { id: 36, cat: 'JavaScript', title: 'You Don\'t Know JS (series)', desc: 'Kyle Simpson\'s deep-dive series — scope, closures, async.', link: 'https://github.com/getify/You-Dont-Know-JS', level: 'Intermediate→Advanced', tag: 'Deep' },
  { id: 37, cat: 'React', title: 'React Patterns by Michael Chan', desc: 'Common component patterns: compound, render props, controlled.', link: 'https://reactpatterns.com', level: 'Intermediate' },
  { id: 38, cat: 'React', title: 'Epic React by Kent C. Dodds (free workshops)', desc: 'Fundamental workshop repos from epicreact.dev are free on GitHub.', link: 'https://github.com/kentcdodds/epic-react', level: 'Beginner→Advanced' },
  { id: 39, cat: 'TypeScript', title: 'Type Challenges', desc: 'Progressive, GitHub-hosted type puzzles.', link: 'https://github.com/type-challenges/type-challenges', level: 'Intermediate→Expert', tag: 'Fun' },
  { id: 40, cat: 'TypeScript', title: 'Total TypeScript (Matt Pocock)', desc: 'Free tutorials by the TS wizard; type utilities deep-dive.', link: 'https://totaltypescript.com', level: 'Intermediate' },
  { id: 41, cat: 'Node', title: 'Node Best Practices (goldbergyoni)', desc: '100+ best practices for production Node.js apps.', link: 'https://github.com/goldbergyoni/nodebestpractices', level: 'All', tag: 'Must-read' },
  { id: 42, cat: 'Python', title: 'Real Python Tutorials', desc: 'Many parts are free — production-grade Python content.', link: 'https://realpython.com', level: 'All' },
  { id: 43, cat: 'Python', title: 'Python Tutor (visualizer)', desc: 'Step through code live and watch memory frames animate.', link: 'http://pythontutor.com', level: 'Beginner', tag: 'Visual' },
  { id: 44, cat: 'Python', title: 'Automate The Boring Stuff (free book)', desc: 'Master Excel, PDF, web scraping, email automation using Python.', link: 'https://automatetheboringstuff.com', level: 'Beginner' },
  { id: 45, cat: 'Python', title: 'FastAPI Tiangolo Docs', desc: 'The official FastAPI docs are a complete course by themselves.', link: 'https://fastapi.tiangolo.com', level: 'Intermediate' },
  { id: 46, cat: 'Rust', title: 'The Rust Book', desc: 'Official book — the definitive way to learn Rust fundamentals.', link: 'https://doc.rust-lang.org/book', level: 'Beginner', tag: 'Official' },
  { id: 47, cat: 'Rust', title: 'Rustlings', desc: 'Interactive exercises used by the Rust team itself.', link: 'https://github.com/rust-lang/rustlings', level: 'Beginner' },
  { id: 48, cat: 'Rust', title: 'Zero To Production (Luca Palmieri)', desc: 'Free building-backend guide for Rust APIs.', link: 'https://zero2prod.com', level: 'Intermediate' },
  { id: 49, cat: 'Go', title: 'Go By Example', desc: 'No-nonsense code-first tutorials on Go topics.', link: 'https://gobyexample.com', level: 'Beginner' },
  { id: 50, cat: 'Go', title: 'A Tour of Go', desc: 'Official interactive Go course by the Go team.', link: 'https://go.dev/tour', level: 'Beginner', tag: 'Official' },
  { id: 51, cat: 'DevOps', title: 'KodeKloud Labs (Docker/K8s)', desc: 'Free Docker and Kubernetes labs in the browser.', link: 'https://kodekloud.com', level: 'Beginner→Intermediate' },
  { id: 52, cat: 'DevOps', title: 'Catapult Labs (containers.dev)', desc: 'Interactive container tutorials, WASM demos.', link: 'https://contained.dev', level: 'Intermediate' },
  { id: 53, cat: 'Cloud', title: 'Google Codelabs (free)', desc: 'GCP and cloud fundamentals labs in bite-sized steps.', link: 'https://codelabs.developers.google.com', level: 'Beginner' },
  { id: 54, cat: 'Cloud', title: 'CF Worker Playground (Workers.link)', desc: 'Write Cloudflare Workers directly in the browser.', link: 'https://cloudflareworkers.com', level: 'Intermediate' },
  { id: 55, cat: 'Database', title: 'SQLBolt Interactive', desc: 'Practice SQL with interactive lessons covering full SQL syntax.', link: 'https://sqlbolt.com', level: 'Beginner', tag: 'Interactive' },
  { id: 56, cat: 'Database', title: 'Use The Index, Luke', desc: 'Definitive, free guide on database indexing for devs.', link: 'https://use-the-index-luke.com', level: 'Intermediate→Advanced' },
  { id: 57, cat: 'Redis', title: 'Try Redis Interactive', desc: 'Browser-based Redis REPL with guided tutorials.', link: 'https://try.redis.io', level: 'Beginner' },
  { id: 58, cat: 'HTML', title: 'Interneting Is Hard (tutorial)', desc: 'Friendly HTML & CSS course from Oliver James.', link: 'https://internetingishard.com', level: 'Beginner' },
  { id: 59, cat: 'Git', title: 'Oh Sh*t, Git!?!', desc: 'Humor-driven survival guide for common Git mistakes.', link: 'https://ohshitgit.com', level: 'All', tag: 'Fun' },
  { id: 60, cat: 'DSA', title: 'The Ultimate DSA Roadmap (love babbar)', desc: 'Free, YouTube-based DSA series loved by 500k+ students.', link: 'https://youtube.com/c/LoveBabbar', level: 'Beginner→Intermediate' },
  { id: 61, cat: 'DSA', title: 'Visualgo', desc: 'Visualize dozens of algorithms and data structures live.', link: 'https://visualgo.net', level: 'Beginner→Intermediate', tag: 'Visual' },
  { id: 62, cat: 'DSA', title: 'LeetCode Pattern (seanprashad)', desc: 'Organize LeetCode 170+ problems by pattern.', link: 'https://seanprashad.com/leetcode-patterns', level: 'Interview' },
  { id: 63, cat: 'Security', title: 'PortSwigger Web Security Academy', desc: 'Free, browser-based vuln labs: covering OWASP Top 10.', link: 'https://portswigger.net/web-security', level: 'Beginner→Advanced', tag: 'Free Labs' },
  { id: 64, cat: 'Security', title: 'TryHackMe Pre-Security Path', desc: 'Guided path of networking, Linux, and web basics.', link: 'https://tryhackme.com', level: 'Beginner' },
  { id: 65, cat: 'Security', title: 'PicoCTF', desc: 'CMU-run gamified CTF for students.', link: 'https://picoctf.org', level: 'Beginner' },
  { id: 66, cat: 'Mobile', title: 'Flutter Full Course (CodePur)', desc: 'Free Hindi/English Flutter series with widgets deep-dives.', link: 'https://youtube.com/c/FlutterDevs', level: 'Beginner→Intermediate' },
  { id: 67, cat: 'Mobile', title: 'Android Kotlin Fundamentals (Google)', desc: 'Official codelabs guide for Android development.', link: 'https://developer.android.com/courses', level: 'Beginner', tag: 'Official' },
  { id: 68, cat: 'AI', title: 'Prompt Engineering Guide', desc: 'Open community-driven guide: prompts, LLMs, agents, RAG.', link: 'https://www.promptingguide.ai', level: 'All', tag: 'Trending' },
  { id: 69, cat: 'AI', title: 'HuggingFace Course', desc: 'Free Transformers/LLM course with fine-tuning walkthroughs.', link: 'https://huggingface.co/learn/nlp-course', level: 'Intermediate', tag: 'Official' },
  { id: 70, cat: 'AI', title: 'Fast.ai Practical Deep Learning', desc: 'Top-down hands-on deep learning with zero math degree (but heavy coding).', link: 'https://course.fast.ai', level: 'Intermediate' },
  { id: 71, cat: 'AI', title: 'Karpathy Neural Networks From Zero', desc: 'Free Micrograd series: build a neural net by hand.', link: 'https://karpathy.ai/zero-to-hero', level: 'All', tag: 'Must-watch' },
  { id: 72, cat: 'Design', title: 'NNGroup UX Research (free)', desc: 'Nielsen Norman Group: 1000s of evidence-based usability articles.', link: 'https://nngroup.com', level: 'All' },
  { id: 73, cat: 'Design', title: 'Refactoring UI (free extras)', desc: 'Johnny UI tips that suggest immediate improvements.', link: 'https://refactoringui.com', level: 'Beginner' },
  { id: 74, cat: 'Career', title: 'Tech Career Guide By Career Vault', desc: 'An aggregated, open handbook covering hundreds of tech roles.', link: 'https://careervault.io', level: 'All' },
  { id: 75, cat: 'Career', title: 'Coding Interview University', desc: 'Google-level interview prep by JW Amman (originally created for self).', link: 'https://github.com/jwasham/coding-interview-university', level: 'Advanced', tag: 'Repo' },
  { id: 76, cat: 'Career', title: 'Developer Roadmap repos (OSS)', desc: 'Insightful, community-tracked developer roadmaps.', link: 'https://roadmap.sh', level: 'All' },
  { id: 77, cat: 'CSS', title: 'CSS For JavaScript Developers', desc: 'Free guides on layout, responsive styles, cheat-sheets for devs who prefer JS.', link: 'https://css-for-js.dev', level: 'Beginner' },
  { id: 78, cat: 'CSS', title: 'Grid Guide (grid.malven.co)', desc: 'Complete Visual guides covering grid properties interactively.', link: 'https://grid.malven.co', level: 'Beginner', tag: 'Visual' },
  { id: 79, cat: 'CSS', title: 'Flexbox Froggy Game', desc: 'Touch frogs into ponds while learning flex properties.', link: 'https://flexboxfroggy.com', level: 'Beginner', tag: 'Fun' },
  { id: 80, cat: 'CSS', title: 'CSS-Tricks Almanac', desc: 'Trusted deep directory of every CSS topic with examples.', link: 'https://css-tricks.com', level: 'All' },
  { id: 81, cat: 'Web Dev', title: 'Web Components Intro', desc: 'Build native custom elements with frameworks or vanilla JS.', link: 'https://webcomponents.dev', level: 'Intermediate' },
  { id: 82, cat: 'Web Dev', title: 'Accessibility Daily (free)', desc: 'WAI-ARIA lesson series on making inclusive UIs.', link: 'https://a11y.coffee', level: 'Intermediate' },
  { id: 83, cat: 'Web Dev', title: 'Arcade: Fun with Positioned Elements', desc: 'Web-based interactive lesson on CSS positioning.', link: 'https://learnlayout.com', level: 'Beginner' },
  { id: 84, cat: 'Bash', title: 'Bash Cheatsheet (devhints)', desc: 'Reference + best practices for Bash scripting.', link: 'https://devhints.io/bash', level: 'Beginner' },
  { id: 85, cat: 'Linux', title: 'Linux Journey (free)', desc: 'Self-paced site covering networking, commands, users, systemd.', link: 'https://linuxjourney.com', level: 'Beginner→Intermediate' },
  { id: 86, cat: 'Docker', title: 'Play With Docker (PWD)', desc: 'Free temporary Docker playgrounds in-browser — great for experimenting.', link: 'https://labs.play-with-docker.com', level: 'Beginner', tag: 'Online' },
  { id: 87, cat: 'Kubernetes', title: 'Play With Kubernetes (PWK)', desc: 'Like PWD but a K8s environment online — completely free.', link: 'https://labs.play-with-k8s.com', level: 'Intermediate', tag: 'Online' },
  { id: 88, cat: 'Testing', title: 'Testing JavaScript (free repo)', desc: 'Kent C. Dodds repos covering RTL patterns, unit + integration tests.', link: 'https://testingjavascript.com', level: 'Intermediate' },
  { id: 89, cat: 'Testing', title: 'Playwright Docs', desc: 'Excellent cross-browser testing, visual diff, emulation guides — free.', link: 'https://playwright.dev', level: 'Intermediate' },
  { id: 90, cat: 'API', title: 'Awesome APIs List (OSS)', desc: 'Curated list of public APIs — free endpoints in every domain.', link: 'https://github.com/public-apis/public-apis', level: 'All', tag: 'Giant List' },
  { id: 91, cat: 'API', title: 'JSONPlaceholder', desc: 'Free fake REST API for prototyping frontends.', link: 'https://jsonplaceholder.typicode.com', level: 'Beginner', tag: 'Essential' },
  { id: 92, cat: 'GraphQL', title: 'GraphQL How To Learn (graphql.org)', desc: 'Official tutorial covering queries, mutations, schemas.', link: 'https://graphql.org/learn', level: 'Intermediate' },
  { id: 93, cat: 'GraphQL', title: 'Ashwanth Kathrani GraphQL Course (free)', desc: 'Full YouTube bootcamp on servers + client graphql.', link: 'https://youtube.com', level: 'Intermediate' },
  { id: 94, cat: 'Prisma', title: 'Prisma Quickstart (free)', desc: 'Official start guides covering setup and exchanges.', link: 'https://prisma.io/guides', level: 'Beginner' },
  { id: 95, cat: 'Supabase', title: 'Supabase University (free)', desc: 'Official docs and produced video series are fantastic.', link: 'https://supabase.com/docs', level: 'Beginner' },
  { id: 96, cat: 'Web3', title: 'Encode Club Free Bootcamps', desc: 'Free blockchain/web3 bootcamps with certificates from Encode.', link: 'https://encode.club', level: 'Intermediate', tag: 'Free' },
];
